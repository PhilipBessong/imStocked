...
var __PRIVATE_PersistentStream = class {
  ...
  x_() {
    this.state = 5, this.C_.f_(() => __async(this, null, function* () {
      ...
      n.enqueueAndForget(() => __async(this, null, function* () {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(Xt, "Restarting streams for network reachability change."), yield function __PRIVATE_restartNetwork(e3) {
          return __async(this, null, function* () {
            ...
            ), yield __PRIVATE_disableNetworkInternal(t2), t2.da.set(
              "Unknown"
              /* OnlineState.Unknown */
            ), t2.Ta.delete(
              4
...
function __PRIVATE_enableNetworkInternal(e) {
  return __async(this, null, function* () {
    if (__PRIVATE_canUseNetwork(e)) for (const t of e.Ia) yield t(
      /* enabled= */
      true
    );
  });
        ...
        yield function __PRIVATE_handleTargetError(e2, t2) {
          return __async(this, null, function* () {
            ...
            for (const r of t2.targetIds)
              e2.Pa.has(r) && (yield e2.remoteSyncer.rejectListen(r, n2), e2.Pa.delete(r), e2.Aa.removeTarget(r));
          });
        }(e, t);
      } catch (n2) {
...
function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  return __async(this, null, function* () {
    ...
    yield __PRIVATE_disableNetworkInternal(e), e.da.set(
      "Offline"
      /* OnlineState.Offline */
    ...
    e.asyncQueue.enqueueRetryable(() => __async(this, null, function* () {
      __PRIVATE_logDebug(Xt, "Retrying IndexedDB access"), yield n(), e.Ta.delete(
        1
        /* OfflineCause.IndexedDbFailed */
    ...
    (yield function __PRIVATE_handleWriteError(e2, t2) {
      return __async(this, null, function* () {
        if (function __PRIVATE_isPermanentWriteError(e3) {
          ...
          const n = e2.ha.shift();
          __PRIVATE_ensureWriteStream(e2).O_(), yield __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), // It's possible that with the completion of this mutation
...
function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  return __async(this, null, function* () {
    ...
    n.da.set(
      "Unknown"
      /* OnlineState.Unknown */
    ), yield n.remoteSyncer.handleCredentialChange(t), n.Ta.delete(
      3
      /* OfflineCause.CredentialChange */
...
function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    ...
    ), yield __PRIVATE_enableNetworkInternal(n)) : t || (n.Ta.add(
      2
      /* OfflineCause.IsSecondary */
    ), yield __PRIVATE_disableNetworkInternal(n), n.da.set(
      "Unknown"
      /* OnlineState.Unknown */
    ));
  });
...
function __PRIVATE_ensureWatchStream(e) {
  ...
  }), e.Ia.push((t) => __async(this, null, function* () {
    t ? (e.Ra.O_(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.da.set(
      "Unknown"
      /* OnlineState.Unknown */
    )) : (yield e.Ra.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  }))), e.Ra;
}
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.Va = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    yield __PRIVATE_fillWritePipeline(e)) : (yield e.Va.stop(), e.ha.length > 0 && (__PRIVATE_logDebug(Xt, `Stopping write stream with ${e.ha.length} pending writes`), e.ha = []));
  }))), e.Va;
}
...
var __PRIVATE_BundleLoader = class {
  ...
  complete() {
    return __async(this, null, function* () {
      const e = yield __PRIVATE_localStoreApplyBundledDocuments(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.Qa.id), t = this.Ua(this.documents);
...
function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  return __async(this, null, function* () {
    e.Ru = (t2, n2, r2) => function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
      return __async(this, null, function* () {
...
function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  return __async(this, null, function* () {
    ...
    }), yield Promise.all(o), r.au.j_(i), yield function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
      return __async(this, null, function* () {
...
function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    ...
    if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.Au) {
      ...
      n.Au = true, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
      ...
      }(n), n.Au = false, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
    }
  });
}
  ...
  return __async(this, null, function* () {
    ...
    for (const e2 of t) {
      ...
      if (n2 && 0 !== n2.length) {
        ...
        for (const e3 of n2) {
          const t3 = r.uu.get(e3), n3 = yield __PRIVATE_synchronizeViewAndComputeSnapshot(r, t3);
  ...
  (function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    return __async(this, null, function* () {
      try {
        ...
        let s = yield t2.gu();
        for (; s; ) {
          const e3 = yield i.$a(s);
          e3 && n2._updateProgress(e3), s = yield t2.gu();
        }
...
var __PRIVATE_MemoryOfflineComponentProvider = class {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      this.serializer = __PRIVATE_newSerializer(e.databaseInfo.databaseId), this.sharedClientState = this.pu(e), this.persistence = this.yu(e), yield this.persistence.start(), this.localStore = this.wu(e), this.gcScheduler = this.Su(e, this.localStore), this.indexBackfillerScheduler = this.bu(e, this.localStore);
    });
  }
  Su(e, t) {
    return null;
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class ___PRIVATE_IndexedDbOfflineComponentProvider extends __PRIVATE_MemoryOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      yield __superGet(___PRIVATE_IndexedDbOfflineComponentProvider.prototype, this, "initialize").call(this, e), yield this.Du.initialize(this, e), // Enqueue writes from a previous session
      yield __PRIVATE_syncEngineEnsureWriteCallbacks(this.Du.syncEngine), yield __PRIVATE_fillWritePipeline(this.Du.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
  ...
  initialize(e) {
    return __async(this, null, function* () {
      ...
      yield this.persistence.Ji((e2) => __async(this, null, function* () {
        yield __PRIVATE_syncEngineApplyPrimaryState(this.Du.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
      }));
    });
  }
  pu(e) {
...
var __PRIVATE_BundleReaderImpl = class {
  ...
  gu() {
    return __async(this, null, function* () {
      return yield this.getMetadata(), this.xu();
    });
  }
  /**
  ...
  Bu(e) {
    return __async(this, null, function* () {
      for (; this.buffer.length < e; ) {
        (yield this.ku()) && this.Nu("Reached the end of bundle when more is expected.");
      }
...
var __PRIVATE_TransactionRunner = class {
  ...
  Uu() {
    this.C_.f_(() => __async(this, null, function* () {
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
    ...
    n.Cu(), e.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
...
var __PRIVATE_AsyncQueueImpl = class {
  ...
  sc() {
    return __async(this, null, function* () {
      if (0 !== this.zu.length) {
        try {
          yield this.zu[0](), this.zu.shift(), this.C_.reset();
        } catch (e) {
...
function onSnapshot(e, ...t) {
  ...
  return function __PRIVATE_firestoreClientListen(e2, t2, n2, r2) {
    ...
    return e2.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
      ...
      i2.Cu(), e2.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
